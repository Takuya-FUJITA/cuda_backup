...
df_train = pd.read_csv('./TrainingData/DataSet/Dataset_' + WIDTH + '.csv')
df_test = pd.read_csv('/mnt/usbdisk1/NB_DATA/Connect_Tweet/' + WIDTH + 'width/2013-08-12.csv')
...
df_fv_train.to_csv('./TrainingData/' + WIDTH + 'width_train.csv', index=False)
df_fv_test.to_csv('./TrainingData/' + WIDTH + 'width_test.csv', index=False)
